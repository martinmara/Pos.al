    ...
    <div className="main2">
      ...
      <div className="text">
        ...
        <p className="motivatedparagraph">
          Online chat to communicate with the teacher and classmates to achieve
          the best result. Share problems and look for solutions with other
          students. Using chat will help every student to have an incredible
          teamwork experience.
        </p>
      </div>
    </div>
